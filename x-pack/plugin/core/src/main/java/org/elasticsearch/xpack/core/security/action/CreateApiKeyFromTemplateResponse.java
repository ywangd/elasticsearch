 ...
 */
public final class CreateApiKeyFromTemplateResponse extends ActionResponse implements ToXContentObject {

    static final ConstructingObjectParser<CreateApiKeyFromTemplateResponse, Void> PARSER = new ConstructingObjectParser<>("create_api_key_from_template_response",
            args -> new CreateApiKeyFromTemplateResponse((String) args[0], (String) args[1], new SecureString((String) args[2]),
    ...
    public CreateApiKeyFromTemplateResponse(String name, String id, SecureString key, Instant expiration) {
        this.name = name;
        this.id = id;
        this.key = key;
    ...
    public CreateApiKeyFromTemplateResponse(StreamInput in) throws IOException {
        super(in);
    ...
    public boolean equals(Object obj) {
        ...
        final CreateApiKeyFromTemplateResponse other = (CreateApiKeyFromTemplateResponse) obj;
        if (expiration == null) {
    ...
    public static CreateApiKeyFromTemplateResponse fromXContent(XContentParser parser) throws IOException {
    ...
    public String toString() {
        return "CreateApiKeyFromTemplateResponse [name=" + name + ", id=" + id + ", expiration=" + expiration + "]";
    }
