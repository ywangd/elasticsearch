 ...
 */
public final class SyncApiKeyResponse extends ActionResponse implements ToXContentObject {

    public static SyncApiKeyResponse EMPTY = new SyncApiKeyResponse(null, null, null, null);

    static final ConstructingObjectParser<SyncApiKeyResponse, Void> PARSER = new ConstructingObjectParser<>("sync_api_key_response",
            args -> new SyncApiKeyResponse((String) args[0], (String) args[1], new SecureString((String) args[2]),
    ...
    public SyncApiKeyResponse(String name, String id, SecureString key, Instant expiration) {
        this.name = name;
        this.id = id;
        this.key = key;
    ...
    public SyncApiKeyResponse(StreamInput in) throws IOException {
        super(in);
    ...
    public boolean equals(Object obj) {
        ...
        final SyncApiKeyResponse other = (SyncApiKeyResponse) obj;
        if (expiration == null) {
    ...
    public static SyncApiKeyResponse fromXContent(XContentParser parser) throws IOException {
    ...
    public String toString() {
        return "SyncApiKeyResponse [name=" + name + ", id=" + id + ", expiration=" + expiration + "]";
    }
