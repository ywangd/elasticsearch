...
public final class RestCreateCrossClusterKeyAction extends ApiKeyBaseRestHandler {
     ...
     */
    public RestCreateCrossClusterKeyAction(Settings settings, XPackLicenseState licenseState) {
        super(settings, licenseState);
    }

    @Override
    public List<Route> routes() {
        return List.of(new Route(POST, "/_security/cross_cluster_key"));
    }

    @Override
    public String getName() {
        return "xpack_security_create_cross_cluster_key";
    }
    ...
    protected RestChannelConsumer innerPrepareRequest(final RestRequest request, final NodeClient client) throws IOException {
        ...
        return channel -> client.execute(
            CreateCrossClusterKeyAction.INSTANCE,
